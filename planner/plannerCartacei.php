	...
	<body>
		...
		<div id="drop-menu" class="clearfix">
			<ul id="menu">
				...
				<li> <a class="activedue"  href="plannerCartacei.php">planner cartacei</a> </li>
			...
			<?php
				...
				$query="SELECT * FROM planner_comprare WHERE tipo='cartaceo'";
				$risultato=mysqli_query($connessione,$query);
				while($riga=mysqli_fetch_array($risultato)){
					echo("<div class='elencoCartaceo' class='clearfix'>");
				...
				echo("<input type='hidden' value='cartaceo' name='tipo' />");
				echo("</form>");
				?>
